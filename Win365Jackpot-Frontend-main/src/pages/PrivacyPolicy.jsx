...
const SECTIONS = [
  ...
  },
  {
    ...
    content: `All information processed by us may be transferred, processed, and stored anywhere in the world, including but not limited to other countries which may have data protection laws that are different from the laws where you live. We endeavour to safeguard your information consistent with the requirements of applicable laws.`,
  },
  {
    number: '11',
  ...
  },
  {
    ...
    content: `If you are located in the European Economic Area, you have the right to lodge a complaint with a supervisory authority if you believe our processing of your personal information violates applicable law.`,
  },
  {
    number: '13',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {SECTIONS.map(s => (
              <a
                ...
                onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.45)'}
              >
                <span style={{ fontSize: 11, fontFamily: 'monospace', color: 'rgba(212,175,55,0.4)', minWidth: 20 }}>
                  {s.number}.
                </span>
                {s.title}
              </a>
