      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: "rgba(255,255,255,0.5)" }}>{t(sublabelKey)}</div>
          </div>
        </div>
      </div>

      <div style={{ fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif", fontSize: "clamp(1.1rem,3vw,1.35rem)", fontWeight: 700, color, letterSpacing: "-0.01em" }}>
        {type === "rolling_points"
    ...
    >
      ...
      <div style={{ padding: "14px 16px", flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
          <span style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", fontWeight: 500 }}>$</span>
          <span style={{ fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif", fontSize: "clamp(1.4rem,4vw,1.8rem)", fontWeight: 800, color: isClaimed || isExpired ? "rgba(255,255,255,0.3)" : "white", letterSpacing: "-0.02em" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          ...
          {g.created_at && (
            <span style={{ fontSize: 10, color: "rgba(255,255,255,0.4)" }}>{t("gifts.issued", { date: fmtDate(g.created_at) })}</span>
          )}
        </div>
...
export default function GiftsTab({ onToast, onRefresh }) {
  ...
  return (
    <div style={{ fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif", color: "rgba(255,255,255,0.85)", minHeight: "100vh" }}>
      <style>{`
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
            ...
            <h1 style={{ fontSize: 18, fontWeight: 700, color: "white", margin: 0, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif", letterSpacing: "-0.02em" }}>{t("gifts.giftsAndRewards")}</h1>
          </div>
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", margin: 0, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>
        ...
        <button
          onClick={refresh}
          disabled={refreshing}
          style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8, border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.55)", fontSize: 12, cursor: refreshing ? "not-allowed" : "pointer", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}
        >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10, marginBottom: 20 }}>
        {[
          ...
          <div key={label} style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: "12px 14px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6, color: "rgba(255,255,255,0.4)", fontSize: 11, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>
              <span style={{ color }}>{icon}</span> {label}
            </div>
            <div style={{ fontSize: "clamp(1.1rem,3vw,1.4rem)", fontWeight: 800, color, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{value}</div>
            <div style={{ fontSize: 10, color: "rgba(255,255,255,0.45)", marginTop: 2, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{sub}</div>
          </div>
        ))}
      </div>
      ...
      <section style={{ marginBottom: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.1em", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("dashboard.walletBalances")}</span>
        </div>
      ...
      {levelData && (
        <section style={{ marginBottom: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.1em", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("gifts.vipStatus")}</span>
          </div>
          <div style={{ background: "rgba(255,255,255,0.03)", border: `1px solid ${vipColor}22`, borderRadius: 10, padding: "16px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14, flexWrap: "wrap", gap: 10 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  <div style={{ fontSize: 16, fontWeight: 800, color: vipColor, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{vipName}</div>
                  <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>
              ...
              {nextPts && (
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 10, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("gifts.nextLevel")}</div>
                  <div style={{ fontSize: 14, fontWeight: 700, color: "white", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{nextPts.toLocaleString("en-IN")}</div>
                  <div style={{ fontSize: 10, color: "rgba(255,255,255,0.35)", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("gifts.toGo", { count: ptsToNext.toLocaleString("en-IN") })}</div>
                </div>
              )}
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, color: "rgba(255,255,255,0.5)", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>
      ...
      <section>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12, flexWrap: "wrap", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.1em", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("gifts.giftHistory")}</span>
            <span style={{ fontSize: 10, color: "rgba(255,255,255,0.45)", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>· {t("gifts.itemsCount", { count: filtered.length })}</span>
          </div>
        ...
        {loading ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 20px", background: "rgba(255,255,255,0.02)", border: "1px dashed rgba(255,255,255,0.08)", borderRadius: 10 }}>
            ...
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("gifts.noGiftsFound", { filter: filter === "all" ? "" : filter })}</div>
            <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginTop: 4, fontFamily: "'JW Display J', 'Playfair Display', Georgia, 'Times New Roman', serif" }}>{t("gifts.checkBackLater")}</div>
          </div>
        ) : (
